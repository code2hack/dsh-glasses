...
Debug shell for the Rokid glasses: one Activity, one dedicated local-asset
WebView with external navigation blocked, a path-restricted native bridge, an
input tracer, and WebView-owned bootstrap/SSE projection.
