...
- One dedicated branch per active slice (current: `tb0/assistant-output`).
...
- Active slice: `tb0/assistant-output`.
- Base merge: `87a0968e3cf081930d19df214eaacbf8053026aa`.
