---
name: whip-polling
description: Worker Heartbeat Integrity Protocol + mandatory ChatGPT polling (never stop across rounds/compaction/new sessions; act on replies first; usage-limit -> lower think effort). Load this skill as the FIRST action of any dsh-glasses worker session.
---
